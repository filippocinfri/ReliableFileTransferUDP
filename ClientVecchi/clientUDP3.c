...
thread:
	...
	simula la perdita del pacchetto
	se non è stato perso, invia un messaggio al server
	attende la risposta
	stampa la risposta
	termina il thread
*/
...
#define timeOutSec	5	// secondi per la scadenza del timer
#define windowSize	4	// dimensione della finestra del selective repeat
#define maxRichieste	100	// numero massimo di richieste che si possono effettuare
